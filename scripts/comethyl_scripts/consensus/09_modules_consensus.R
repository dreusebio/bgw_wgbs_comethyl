...
#   --regions_file   : path to joint_eligible_regions_4col.tsv from revised
#                      Script 05b (or Filtered_Regions.txt in legacy mode)
...
#   - Joint-dynamic mode must use Script 05b's matching region table; passing
#     the earlier Script 02 table would reintroduce regions removed in 05b.
